  ...
  return (
    <>
      <motion.button
        ...
        className="fixed bg-[#0080ff] bottom-4 right-4 object-cover flex items-center justify-center text-sm font-medium disabled:pointer-events-none disabled:opacity-50 border rounded-full w-16 h-16 m-0 cursor-pointer border-gray-200 bg-none p-0 normal-case leading-5 hover:text-gray-900 z-10"
        type="button"
