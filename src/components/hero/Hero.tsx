          ...
          >
            ...
            <div className="mt-8 flex space-x-6">
              <a
                ...
                className="text-gray-600 z-10 relative hover:text-primary dark:text-gray-300 dark:hover:text-primary transition-colors duration-300 cursor-pointer"
              >
          ...
          >
            <div className="relative w-64 h-64 mx-auto">
              <Image
                ...
                layout="fill"
                objectFit="cover"
                className="rounded-full shadow-2xl z-[2] "
              />
              <motion.svg
                style={{ left: "-32px", top: "-32px" }}
                className="absolute z-1  w-80 h-80 text-primary opacity-50"
                viewBox="0 0 200 200"
